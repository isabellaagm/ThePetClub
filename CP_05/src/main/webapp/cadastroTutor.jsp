...
<body class="bg-pink">
    <main class="bg-pink d-flex justify-content-center align-items-center flex-column">
        ...
        <h1 class="col text-yonky my-4">Cadastro Tutor</h1>
        
        
        <form class="w-75 text-varche" action="NovoTutorServlet" method="post">
            ...
            <input type="text" class="mb-3 form-control rounded-pill" placeholder="Endereco" name="endereco"/>
            <input type="text" class="mb-3 form-control rounded-pill" placeholder="Senha" name="senha"/>
